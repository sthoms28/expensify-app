...
var IndecisonApp = function (_React$Component) {
  ...
  _createClass(IndecisonApp, [{
    ...
    key: 'componentWillUnmmount',
    value: function componentWillUnmmount() {
    ...
    value: function render() {
      ...
      var subtitle = 'Put your life in the binary hands of a computer';
...
var Additions = function (_React$Component2) {
  _inherits(Additions, _React$Component2);

  function Additions(props) {
    _classCallCheck(this, Additions);

    var _this2 = _possibleConstructorReturn(this, (Additions.__proto__ || Object.getPrototypeOf(Additions)).call(this, props));
...
ReactDOM.render(React.createElement(IndecisonApp, { options: ['Devils den', 'Second District'] }), document.getElementById('app'));
